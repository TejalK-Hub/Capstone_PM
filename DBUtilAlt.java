...
/**
 * Alternative Database utility class for managing connections
 * This class tries multiple approaches to load the properties file
 */
public class DBUtilAlt {
    ...
    static {
        try {
            ...
            InputStream inputStream = DBUtilAlt.class.getClassLoader().getResourceAsStream(PROPERTIES_FILE);
            if (inputStream != null) {
